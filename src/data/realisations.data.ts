export const portfolioHeroData = {
  ...
  // Liste de tes clients/technologies. 
  // J'ai mis le logo de Nuru par défaut comme sur ta maquette, mais tu pourras les remplacer par les vrais logos de tes clients.
  clientLogos: [
